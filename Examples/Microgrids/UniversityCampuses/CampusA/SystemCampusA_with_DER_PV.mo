...
model SystemCampusA_with_DER_PV "Campus Model 1"
  ...
  OpenIPSL.Electrical.Loads.PSSE.Load L1(
    ...
    v_0=PF_results.voltages.VB1L5,
    angle_0=PF_results.voltages.AB1L5)
  ...
  Electrical.Renewables.PSSE.PV PV1(
    V_b=600,
    P_0(displayUnit="kW") = PF_results.photovoltaic.PPV1,
    Q_0=PF_results.photovoltaic.QPV1,
    v_0=PF_results.voltages.VPV1B1,
    angle_0=PF_results.voltages.APV1B1,
    QFunctionality=0,
  ...
  Electrical.Buses.Bus          PV1B1(
    V_b=13800,
    v_0=PF_results.voltages.VPV1B1,
    angle_0=PF_results.voltages.APV1B1)         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-120,-260})));
  ...
  Electrical.Buses.Bus          PV1B2(
    V_b=13800,
    v_0=PF_results.voltages.VPV1B2,
    angle_0=PF_results.voltages.APV1B2)         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-120,-228})));
  ...
  Electrical.Renewables.PSSE.PV PV2(
    V_b=600,
    P_0(displayUnit="kW") = PF_results.photovoltaic.PPV2,
    Q_0=PF_results.photovoltaic.QPV2,
    v_0=PF_results.voltages.VPV2B1,
    angle_0=PF_results.voltages.APV2B1,
    QFunctionality=0,
    redeclare OpenIPSL.Electrical.Renewables.PSSE.InverterInterface.REGCA1
      RenewableGenerator,
    redeclare OpenIPSL.Electrical.Renewables.PSSE.ElectricalController.REECB1
  ...
  Electrical.Buses.Bus          PV2B1(
    V_b=13800,
    v_0=PF_results.voltages.VPV2B1,
    angle_0=PF_results.voltages.APV2B1)         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-30,-260})));
  ...
  Electrical.Buses.Bus          PV2B2(
    V_b=13800,
    v_0=PF_results.voltages.VPV2B2,
    angle_0=PF_results.voltages.APV2B2)         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-30,-228})));
  ...
  Electrical.Renewables.PSSE.PV PV3(
    V_b=600,
    P_0(displayUnit="kW") = PF_results.photovoltaic.PPV3,
    Q_0=PF_results.photovoltaic.QPV3,
    v_0=PF_results.voltages.VPV3B1,
    angle_0=PF_results.voltages.APV3B1,
    QFunctionality=0,
    redeclare OpenIPSL.Electrical.Renewables.PSSE.InverterInterface.REGCA1
      RenewableGenerator,
    redeclare OpenIPSL.Electrical.Renewables.PSSE.ElectricalController.REECB1
  ...
  Electrical.Buses.Bus          PV3B1(
    V_b=13800,
    v_0=PF_results.voltages.VPV3B1,
    angle_0=PF_results.voltages.APV3B1)         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={140,-42})));
  ...
  Electrical.Buses.Bus          PV3B2(
    V_b=13800,
    v_0=PF_results.voltages.VPV3B2,
    angle_0=PF_results.voltages.APV3B2)         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={140,-10})));
  ...
  Electrical.Renewables.PSSE.PV PV4(
    V_b=600,
    P_0(displayUnit="kW") = PF_results.photovoltaic.PPV4,
    Q_0=PF_results.photovoltaic.QPV4,
    v_0=PF_results.voltages.VPV4B1,
    angle_0=PF_results.voltages.APV4B1,
    QFunctionality=0,
    redeclare OpenIPSL.Electrical.Renewables.PSSE.InverterInterface.REGCA1
      RenewableGenerator,
    redeclare OpenIPSL.Electrical.Renewables.PSSE.ElectricalController.REECB1
  ...
  Electrical.Buses.Bus          PV4B1(
    V_b=13800,
    v_0=PF_results.voltages.VPV4B1,
    angle_0=PF_results.voltages.APV4B1)         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={50,-70})));
  ...
  Electrical.Buses.Bus          PV4B2(
    V_b=13800,
    v_0=PF_results.voltages.VPV4B2,
    angle_0=PF_results.voltages.APV4B2)         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={50,-38})));
  ...
  Electrical.Renewables.PSSE.PV PV5(
    V_b=600,
    P_0=PF_results.photovoltaic.PPV5,
    Q_0=PF_results.photovoltaic.QPV5,
    v_0=PF_results.voltages.VPV5B1,
    angle_0=PF_results.voltages.APV5B1,
    QFunctionality=0,
    redeclare OpenIPSL.Electrical.Renewables.PSSE.InverterInterface.REGCA1
      RenewableGenerator,
    redeclare OpenIPSL.Electrical.Renewables.PSSE.ElectricalController.REECB1
  ...
  Electrical.Buses.Bus          PV5B1(
    V_b=13800,
    v_0=PF_results.voltages.VPV5B1,
    angle_0=PF_results.voltages.APV5B1)         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={90,-32})));
  ...
  Electrical.Buses.Bus          PV5B2(
    V_b=13800,
    v_0=PF_results.voltages.VPV5B2,
    angle_0=PF_results.voltages.APV5B2)         annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={90,0})));
  ...
  OpenCPS.Controls.FREQ_CALC
            fREQ_CALC(
    T_w=0.05,
    T_f=3/2/Modelica.Constants.pi/60,
    fi_0=PF_results.voltages.AB5L5)
                         annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        origin={150,-150})));
  Modelica.Blocks.Sources.RealExpression realExpression(y=B5L5.angle)
    annotation (Placement(transformation(extent={{100,-160},{120,-140}})));
  Modelica.Blocks.Math.Add Frequency
    annotation (Placement(transformation(extent={{170,-166},{190,-146}})));
  Modelica.Blocks.Sources.Constant const(k=SysData.fn)
    annotation (Placement(transformation(extent={{140,-190},{160,-170}})));
  Electrical.Events.Breaker          Br4(rc_enabled=false, t_rc=10.5)
    annotation (Placement(transformation(extent={{-154,-200},{-142,-188}})));
  Electrical.Sources.VoltageSourceReImInput voltageSourceReImInput(
  V_b=13800,
  v_0=PF_results.voltages.VB1L3,
    angle_0=PF_results.voltages.AB1L3) annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={12,226})));
  Modelica.Blocks.Sources.Constant const1(k=1.00146)
    annotation (Placement(transformation(extent={{-20,260},{-10,270}})));
  Modelica.Blocks.Sources.Constant const2(k=-0.0104)
    annotation (Placement(transformation(extent={{-20,242},{-10,252}})));
  inner Data.PF_results PF_results(
    ...
    redeclare record Photovoltaic =
        OpenIPSL.Examples.Microgrids.UniversityCampuses.CampusA.Data.RenewablesCampus1)
    annotation (Placement(transformation(extent={{154,-258},{174,-238}})));
equation
  ...
  connect(ST.pwPin, BrST.s)
    annotation (Line(points={{120,179},{120,192}}, color={0,0,255}));
  ...
  connect(GT1.pwPin, BrGT1.s)
    annotation (Line(points={{-90,181},{-90,192}}, color={0,0,255}));
  connect(GT2.pwPin, BrGT2.s)
    annotation (Line(points={{80,179},{80,192}}, color={0,0,255}));
  ...
  connect(realExpression.y, fREQ_CALC.ANGLE)
    annotation (Line(points={{121,-150},{141,-150}}, color={0,0,127}));
  connect(fREQ_CALC.d_FREQ, Frequency.u1)
    annotation (Line(points={{161,-150},{168,-150}}, color={0,0,127}));
  connect(const.y, Frequency.u2) annotation (Line(points={{161,-180},{168,-180},
          {168,-162}}, color={0,0,127}));
  connect(Line26.n, Br4.s) annotation (Line(points={{-120,-205},{-142,-205},{-142,
          -204},{-162,-204},{-162,-194},{-154,-194}}, color={0,0,255}));
  connect(Br4.r, B1L9.p) annotation (Line(points={{-142,-194},{-124,-194},{-124,
          -196},{-100,-196},{-100,-188}}, color={0,0,255}));
  connect(voltageSourceReImInput.p, BrU.r)
    annotation (Line(points={{12,215},{12,202}}, color={0,0,255}));
  connect(const1.y, voltageSourceReImInput.vRe)
    annotation (Line(points={{-9.5,265},{16,265},{16,238}}, color={0,0,127}));
  connect(const2.y, voltageSourceReImInput.vIm)
    annotation (Line(points={{-9.5,247},{8,247},{8,238}}, color={0,0,127}));
