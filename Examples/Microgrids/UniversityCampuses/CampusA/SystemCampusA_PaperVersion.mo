...
model SystemCampusA_PaperVersion "Campus Model 1"
  ...
  inner Data.PF_results PF_results(
    redeclare record Voltages = Data.VoltagesCampus1,
    redeclare record Machines = Data.MachinesCampus1,
    redeclare record Loads = Data.LoadsCampus1,
    redeclare record Photovoltaic = Data.RenewablesCampus1)
    annotation (Placement(transformation(extent={{146,-258},{166,-238}})));
equation
  ...
  connect(GT1.pwPin, BrGT1.s)
    annotation (Line(points={{-89,183.5},{-89,186},{-90,186},{-90,192}},
                                                   color={0,0,255}));
  ...
  connect(BrU.r, UTILITY.p)
    annotation (Line(points={{12,202},{12,220},{4,220}}, color={0,0,255}));
