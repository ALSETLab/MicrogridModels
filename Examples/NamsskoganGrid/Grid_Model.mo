...
equation
  connect(twoWindingTransformer.p, B3.n[1]) annotation (Line(points={{241,-78},{262,-78},{290,-78},{290,-94}},
                                         color={0,0,255}));
  connect(B2.n[1], twoWindingTransformer.n) annotation (Line(points={{166.4,-80},
          {172,-80},{172,-78},{219,-78}}, color={0,0,255}));
  ...
  connect(B4.p[1], Line2_4.n) annotation (Line(points={{134,-34},{138,-34},{138,-44},{138,-46},{144,-46},{144,-51}},
                                               color={0,0,255}));
  connect(B5.n[1], voltDependant3.p) annotation (Line(points={{110.95,4},{112,4},
          {112,8},{153,8},{153,-2}},color={0,0,255}));
  connect(B5.n[2], Line5_23.n) annotation (Line(points={{107.65,4},{110,4},{110,
          12},{110,18},{102,18},{102,29},{100,29}}, color={0,0,255}));
  connect(B5.n[3], Line56_2.p) annotation (Line(points={{104.35,4},{108,4},{108,
          12},{92,12},{92,30},{69,30}}, color={0,0,255}));
  connect(B6.p[1], Line56_2.n) annotation (Line(points={{20,21.3},{38,21.3},{38,
          30},{51,30}}, color={0,0,255}));
  connect(B6.p[2], line56_1.p) annotation (Line(points={{20,14.7},{38,14.7},{38,
          6},{49,6}}, color={0,0,255}));
  connect(Line6_11.p, B6.n[1])
    annotation (Line(points={{-23,18},{16,18},{16,21.3}}, color={0,0,255}));
  ...
  connect(B23.n[1], Line26_1.n) annotation (Line(points={{102.4,64},{108,64},{
          108,64},{145,64}}, color={0,0,255}));
  connect(B26.p[1], voltDependant1.p) annotation (Line(points={{102.95,108},{
          104,108},{104,96},{121,96},{121,92}},
                                            color={0,0,255}));
  connect(B26.p[2], Line2326_2.p)
    annotation (Line(points={{99.65,108},{98,108},{98,93}}, color={0,0,255}));
  connect(B26.p[3], Line2326_1.p) annotation (Line(points={{96.35,108},{96,108},
  ...
  connect(Line31_32.p, B32.n[1]) annotation (Line(points={{165,164},{190,164},{
          190,143.3},{210,143.3}}, color={0,0,255}));
  ...
  connect(B27.n[1], Line26_29.n) annotation (Line(points={{199.3,96},{202,96},{
  ...
  connect(B30.n[1], twoWindingTransformer11.p) annotation (Line(points={{342,20},{346,20},{346,43},{328,43}},
                                       color={0,0,255}));
  connect(B11.n[1], voltDependant.p) annotation (Line(points={{-84,20.4},{-94,
          20.4},{-94,-4}}, color={0,0,255}));
  ...
  connect(B15.n[1], twoWindingTransformer5.p) annotation (Line(points={{-44,114},{-48,114},{-48,110},{-56,110},{-63,110}},
                                                    color={0,0,255}));
  connect(B6.n[2], Line6_7.p) annotation (Line(points={{16,14.7},{14,14.7},{14,
          10},{2,10},{2,-7}}, color={0,0,255}));
  connect(B7.p[1], Line7_9.p) annotation (Line(points={{-8.7,-46},{-4,-46},{-4,
  ...
  connect(twoWindingTransformer4.n, B13.n[1]) annotation (Line(points={{-114,-103},{-114,-116},{-122,-116}},
                                    color={0,0,255}));
  connect(B16.n[1], Line11_16.n) annotation (Line(points={{-190.7,-16},{-190.7,
          22},{-141,22}}, color={0,0,255}));
  connect(B19.n[1], Line16_19.n) annotation (Line(points={{-262.7,-10},{-262.7,
  ...
  connect(voltDependant2.p, B2.n[3]) annotation (Line(points={{124,-78},{126,
          -78},{126,-72},{157.6,-72},{157.6,-80}},
                                              color={0,0,255}));
  connect(B11.n[3], Line11_16.p) annotation (Line(points={{-84,11.6},{-102,11.6},
          {-102,22},{-123,22}}, color={0,0,255}));
  connect(Line19_21.n, B19.n[2]) annotation (Line(points={{-284,15},{-278,15},{
          -278,-4},{-269.3,-4},{-269.3,-10}}, color={0,0,255}));
  ...
  connect(Line6_11.n, B11.p[1]) annotation (Line(points={{-41,18},{-60,18},{-60,
          19.3},{-80,19.3}},                                                                       color={0,0,255}));
  connect(Line7_1.n, B11.p[2]) annotation (Line(points={{-66,-21},{-68,-21},{
          -68,12.7},{-80,12.7}},                                                                  color={0,0,255}));
  ...
  connect(Line26_31.n, B26.n[1]) annotation (Line(points={{94,123},{96,123},{96,
          112},{101.3,112}},                                                                       color={0,0,255}));
  connect(Line26_27.n, B26.n[2]) annotation (Line(points={{147,116},{100,116},{
          100,112},{94.7,112}},                                                                      color={0,0,255}));
