...
model REECB1_with_PIDBlock
  "Electrical control model for large scale photovoltaic with PID BLOCK"
  extends
...
equation
  ...
  connect(product3.y, PI.u) annotation (Line(points={{75,0},{96,0},{96,48},{106,
          48}}, color={0,0,127}));
  connect(PI.y, variableLimiter2.u)
    annotation (Line(points={{129,48},{160,48}}, color={0,0,127}));
